...
// Como gerar uma ID de 4 dígitos? Valores entre 1000 e 9999

// console.log(1000 + Math.random() * 10000);
...
const generateTasksIds = (array) => {

	array.reduce((arrayRetorno, elemento) => {
...
const tasksSortedByIds = (
	arrayTasks,
	tasksWithIds = generateTasksIds(arrayTasks)
) => {
